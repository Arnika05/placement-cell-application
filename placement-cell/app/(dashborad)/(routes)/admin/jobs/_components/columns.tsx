...
import { ArrowUpDown, Eye, MoreHorizontalIcon, Pencil } from "lucide-react";
...
export const columns: ColumnDef<JobsColumns>[] = [
  ...
  },
  {
    ...
    cell: ({row}) => {
        ...
        return(
            <div className={cn("border px-2 py-1 text-xs rounded-md text-center w-24",
                isPublished ? "border-emerald-500 bg-emerald-100/80" : "border-red-500 bg-red-100/80"
            )}>
